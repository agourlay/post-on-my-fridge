...
libraryDependencies ++= Seq(
  ...
  ,"com.typesafe.akka"  %%  "akka-actor"                    % "2.3-SNAPSHOT"               withSources()
  ,"com.typesafe.akka"  %%  "akka-slf4j"                    % "2.3-SNAPSHOT"               withSources()
  ,"com.typesafe.akka"  %%  "akka-testkit"                  % "2.3-SNAPSHOT"    % "test"   withSources()
  ...
  ,"org.specs2"         %%  "specs2"                        % "2.2.1"           % "test"   withSources()  
)
